...
exports.getCountryShortName = function(country) {
    if (country) {
        for (var name in this.countries) {
            if (this.countries[name] == country) {
                return name;
            }
        }
    }
...
exports.getStateShortName = function(state, country) {
    if (state && country && country.toUpperCase() == 'US') {
        for (var name in this.usStates) {
            if (this.usStates[name] == state) {
                return name;
            }
        }
    }
